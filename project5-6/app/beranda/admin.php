          ...
          <div class="card-body">
            <div class="tab-content p-0">
              ...
              <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
                ...
                <canvas id="revenue-chart-canvas" height="360" style="height: 300px; display: block; width: 588px;"
                  width="705" class="chartjs-render-monitor"></canvas>
              </div>
        ...
        <div class="card bg-gradient-primary">
          ...
          <div class="card-body">
            <div id="world-map"
              ...
              <svg width="588.177" height="250">
                <g transform="scale(0.42158516020236086) translate(218.07792200000006, 0)">
                  <path
        ...
        <div class="card bg-gradient-info">
          ...
          <div class="card-body">
            ...
            <canvas class="chart chartjs-render-monitor" id="line-chart"
              style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 588px;"
              width="705" height="300"></canvas>
          </div>

          <div class="card-footer bg-transparent">
            <div class="row">
              <div class="col-4 text-center">
                <div style="display:inline;width:60px;height:60px;"><canvas width="72" height="72"
                    ...
                    <div class="datepicker">
                      <div class="datepicker-days" style="">
                        <table class="table table-sm">
                          ...
                          <tbody>
                            <tr>
                              <td data-action="selectDay" data-day="07/30/2023" class="day old weekend">30</td>
                              <td data-action="selectDay" data-day="07/31/2023" class="day old">31</td>
                              ...
                              <td data-action="selectDay" data-day="08/05/2023" class="day weekend">5</td>
                            </tr>
                            <tr>
                              <td data-action="selectDay" data-day="08/06/2023" class="day weekend">6</td>
                              <td data-action="selectDay" data-day="08/07/2023" class="day">7</td>
                              <td data-action="selectDay" data-day="08/08/2023" class="day">8</td>
                              ...
                              <td data-action="selectDay" data-day="08/12/2023" class="day weekend">12</td>
                            </tr>
                            <tr>
                              <td data-action="selectDay" data-day="08/13/2023" class="day weekend">13</td>
                              <td data-action="selectDay" data-day="08/14/2023" class="day">14</td>
                              <td data-action="selectDay" data-day="08/15/2023" class="day">15</td>
                              <td data-action="selectDay" data-day="08/16/2023" class="day">16</td>
                              <td data-action="selectDay" data-day="08/17/2023" class="day">17</td>
                              <td data-action="selectDay" data-day="08/18/2023" class="day">18</td>
                              <td data-action="selectDay" data-day="08/19/2023" class="day weekend">19</td>
                            </tr>
                            <tr>
                              <td data-action="selectDay" data-day="08/20/2023" class="day active today weekend">20</td>
                              <td data-action="selectDay" data-day="08/21/2023" class="day">21</td>
                              <td data-action="selectDay" data-day="08/22/2023" class="day">22</td>
                              <td data-action="selectDay" data-day="08/23/2023" class="day">23</td>
                              <td data-action="selectDay" data-day="08/24/2023" class="day">24</td>
                              <td data-action="selectDay" data-day="08/25/2023" class="day">25</td>
                              <td data-action="selectDay" data-day="08/26/2023" class="day weekend">26</td>
                            </tr>
                            <tr>
                              <td data-action="selectDay" data-day="08/27/2023" class="day weekend">27</td>
                              <td data-action="selectDay" data-day="08/28/2023" class="day">28</td>
                              <td data-action="selectDay" data-day="08/29/2023" class="day">29</td>
                              <td data-action="selectDay" data-day="08/30/2023" class="day">30</td>
                              <td data-action="selectDay" data-day="08/31/2023" class="day">31</td>
                              <td data-action="selectDay" data-day="09/01/2023" class="day new">1</td>
                              <td data-action="selectDay" data-day="09/02/2023" class="day new weekend">2</td>
                            </tr>
                            <tr>
                              <td data-action="selectDay" data-day="09/03/2023" class="day new weekend">3</td>
                              <td data-action="selectDay" data-day="09/04/2023" class="day new">4</td>
                              <td data-action="selectDay" data-day="09/05/2023" class="day new">5</td>
                              <td data-action="selectDay" data-day="09/06/2023" class="day new">6</td>
                              <td data-action="selectDay" data-day="09/07/2023" class="day new">7</td>
                              <td data-action="selectDay" data-day="09/08/2023" class="day new">8</td>
                              <td data-action="selectDay" data-day="09/09/2023" class="day new weekend">9</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                        ...
                        <table class="table-condensed">
                          <thead>
                            <tr>
                              ...
                              <th class="picker-switch" data-action="pickerSwitch" colspan="5" title="Select Year">2023
                              </th>
                              <th class="next" data-action="next"><span class="fa fa-chevron-right"
                          ...
                          <tbody>
                            <tr>
                              <td colspan="7"><span data-action="selectMonth" class="month">Jan</span><span
                                  ...
                                  data-action="selectMonth" class="month active">Aug</span><span
